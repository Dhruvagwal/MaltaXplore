...
const Iteneray = () => {
  ...
  return (
    <motion.div 
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="my-24 md:my-48 px-4 sm:px-8 md:px-16 lg:px-20 xl:px-32"
    >
      {/* Header Section */}
      <motion.div 
        ...
        >
          <div className="flex flex-col md:flex-row w-full justify-between gap-8 md:gap-16">
            <motion.p 
              ...
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl shrink-0 font-semibold leading-[1.5] text-white"
            >
            ...
            <motion.p 
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl md:mt-[-2rem] shrink-0 md:text-right font-bold leading-[1.5]"
            >
              Don't know <br />
              where to start?{" "}
            </motion.p>
